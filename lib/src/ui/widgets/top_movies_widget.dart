  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          S.of(context).TopMovies.toUpperCase(),
          style: TextStyle(
            fontSize: 12,
        ...
        BlocProvider<MovieBloc>(
          create: (context) => MovieBloc()..add(GetTopMoviesListEvent()),
          child: BlocBuilder<MovieBloc, MovieState>(
            builder: (context, state) {
              if (state is MovieLoading) {
                return Center();
              } else if (state is TopMoviesState) {
                List<Movie> movieList = state.topMovieList;

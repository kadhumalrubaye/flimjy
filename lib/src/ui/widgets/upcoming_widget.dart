  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          S.of(context).Upcoming.toUpperCase(),
          style: TextStyle(
            fontSize: 12,
        ...
        BlocProvider<MovieBloc>(
          create: (context) => MovieBloc()..add(GetUpcomingMovieListEvent()),
          child: BlocBuilder<MovieBloc, MovieState>(
            builder: (context, state) {
              if (state is MovieLoading) {
                return Center();
              } else if (state is GetUpcomingMovieListState) {
                List<Movie> movieList = state.getUpcomingMovieListState;

...
import '../bloc/moviedetailbloc/movie_detail_bloc.dart';
import '../bloc/moviedetailbloc/movie_detail_event.dart';
import '../bloc/moviedetailbloc/movie_detail_state.dart';
                        ...
                        children: <Widget>[
                          Container(
                            child: Column(
                              ...
                              children: <Widget>[
                                Text(
                                  S.of(context).Overview.toUpperCase(),
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    S.of(context).ReleaseDate.toUpperCase(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .caption
                                        .copyWith(
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    S.of(context).RunTime.toUpperCase(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .caption
                                        .copyWith(
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    S.of(context).Budget.toUpperCase(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .caption
                                        .copyWith(
                          ...
                          Text(
                            S.of(context).ScreenShots.toUpperCase(),
                          ...
                          SizedBox(height: 10),
                          Text(
                            S.of(context).Casts.toUpperCase(),
                            style: Theme.of(context).textTheme.caption.copyWith(
                                  fontWeight: FontWeight.bold,
                                  fontFamily: 'muli',
                                ),
